...
> **_General trick: (2)_**  -  Tired of reading? Use text-to-speech extension to read along with you. You can also easily control the speed: words per minute and voice. My personal favorite is: https://chrome.google.com/webstore/detail/natural-reader-text-to-sp/kohfgcgbkjodfcfkcackpagifgbcmimk?hl=en (Try the free voice of Google UK English Female en-GB)

### System Design
#### guidelines
Good guideline resource: https://youtu.be/i7twT3x5yv8?si=hc-jdz8dB3_7vYR-
...
#### links
1. Domain Driven Design basic intro: https://redis.io/glossary/domain-driven-design-ddd/
2. Domain Driven Design by Udi Dahan: https://www.youtube.com/watch?v=-iuMjjKQnhg&ab_channel=Domain-DrivenDesignEurope
3. Git repo `awesome-eventstorming`: https://github.com/mariuszgil/awesome-eventstorming/tree/master?tab=readme-ov-file 
4. Facilitator guide: https://medium.com/@springdo/a-facilitators-recipe-for-event-storming-941dcb38db0d 
5. Example - Building Nick’s First Pop Coffe Company: https://buildplease.com/pages/fpc-1/
...
3. Teamistry - The brilliant success of Shackleton's failure: https://www.atlassian.com/blog/podcast/teamistry/season/season-1/the-brilliant-success-of-shackletons-failure
...
18. High Agency: What is it, why is it important, and how to cultivate it: https://www.linkedin.com/pulse/high-agency-its-importance-how-cultivate-shreyas-doshi?utm_source=share&utm_medium=member_android&utm_campaign=share_via
